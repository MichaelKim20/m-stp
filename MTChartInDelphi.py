...
def print_indicator(a_indicator):
    ...
    for i in range(a_indicator.get_max_count()):
        if len(displayList) == 3:
            v0 = a_indicator.get_value(displayList[0], i)
            v1 = a_indicator.get_value(displayList[1], i)
            v2 = a_indicator.get_value(displayList[2], i)
            v3 = a_indicator.get_value(displayList[4], i)
